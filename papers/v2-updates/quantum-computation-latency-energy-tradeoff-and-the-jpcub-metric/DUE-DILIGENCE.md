...
- Corpus check: qnfo-memory-mcp / QWAV semantic search over the living-paper index for 'quantum computation latency energy tradeoff JPCUB'; positioned against the closest QNFO records instead of duplicating them.
