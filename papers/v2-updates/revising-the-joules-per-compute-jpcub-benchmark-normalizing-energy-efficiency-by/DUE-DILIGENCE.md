...
- Corpus check: qnfo-memory-mcp / QWAV semantic search over the living-paper index for 'joules-per-compute energy benchmark normalization'; positioned against the closest QNFO records instead of duplicating them.
