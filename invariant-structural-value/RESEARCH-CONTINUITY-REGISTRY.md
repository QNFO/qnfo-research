...
- 2026-08-14: P7 OUTREACH executed (research v2.88 protocol) — 1 verified recipient contacted: Christian de Ronde (cderonde@gmail.com, verified from arXiv source tarball 2306.13975), D1 id=138, message_id 05d503f4-eab3-41e1-ac4d-dde99a9ec57a, status=sent, subject "A preprint engaging your 'Bohr's Anti-Realist Realism' as constraining literature" (invites adversarial validation of C2; no overclaim; no-repeat-contact count = 1; follow-up eligible 2026-08-24, one max pending response). Test-send to own mailbox id=137 (TEST-SEND-EXTERNAL-1). Excluded per CONNECTION-POINT-UNVERIFIED-1 (no email in arXiv source): De Haro & Butterfield, Knuth, Rovelli. Log: qnfo-skills email-composer references/outreach-log.md (d1a9a17).
- 2026-08-14: v0.3 published (21929902) — concurrent-session frontmatter/internal-token remediation; CMD RED TEAM 5-adversary audit re-verified Vectorize (browser-UA root cause of 403), IndexNow keyfile worker deployed (plain-text key), D1/registry synced to v0.3.
