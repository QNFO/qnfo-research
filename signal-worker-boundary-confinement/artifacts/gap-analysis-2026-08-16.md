...
| DQ-2 (electron-hook-treatise resolve identifier=slug) | **FIXED (2026-08-17)** — identifier backfilled to concept DOI 10.5281/zenodo.21970453 (record 21970736, ownership live-verified: creator Quni-Gudzinas, Rowan Brad / QNFO Research Foundation; conceptrecid=21970453; `changes: 5`); resolve_paper_id re-verification confirms | Zenodo API + D1 SELECT + resolve_paper_id, this session |
