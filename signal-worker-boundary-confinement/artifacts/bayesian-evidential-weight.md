...
|:---|:-----------------------------------------------------------|:------------------------|
| PRE-REG-1 (revised 2026-08-17) | Skin-localized bulk modes in the pure point-gap (NHSE) regime will NOT themselves carry quantized conductance G = nG0 and will NOT be describable as classical field redistribution; quantized conductance in non-Hermitian systems requires line-gap/biorthogonally protected edge channels (PRB 98, 245130, Yu & Zhai 2018), and NHSE can localize such chiral edge channels (PRL 132, 113802, Liu et al. 2024). | Observation of G = nG0 quantization carried by skin-localized bulk modes absent a line-gap protected edge channel, or demonstration that NHSE localization is classical field redistribution → trichotomy (CORR-3) is WRONG. |
