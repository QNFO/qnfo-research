...
% Formatted per Foundations of Physics (Springer Nature) requirements
% using the OFFICIAL Springer Nature LaTeX Template (sn-jnl.cls, v3.1, Dec 2024)
% downloaded from https://www.springernature.com/gp/authors/campaigns/latex-author-support
%
% BUILD: place sn-jnl.cls and sn-mathphys-num.bst in this directory, then:
...
The structure of this paper is as follows. In Section~\ref{sec2}, we survey five major reconstruction approaches, documenting precisely how each relies on macroscopic boundary conditions. In Section~\ref{sec3}, we formalize the macroscopic boundary problem and argue that it constitutes a fundamental gap rather than a minor technicality. In Section~\ref{sec4}, we propose the \emph{closure criterion}---a positive condition that a maximally honest reconstruction must satisfy---and examine which existing approaches come closest to meeting it. In Section~\ref{sec5}, we discuss possible strategies for addressing the gap, including relational approaches, epistemic interpretations, and recent work on quantum reference frames. Section~\ref{sec6} concludes.

% ======================================================================
% 2. A SURVEY OF RECONSTRUCTION APPROACHES
% ======================================================================
\section{A Survey of Reconstruction Approaches}\label{sec2}
...
% ======================================================================
\section{The Macroscopic Boundary Problem}\label{sec3}
...
% ======================================================================
\section{The Closure Criterion}\label{sec4}
