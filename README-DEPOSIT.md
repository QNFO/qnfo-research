...
> Quni-Gudzinas, Rowan Brad. (2026). *Error Correction Is a Landauer Machine: The Thermodynamic Floor of Quantum Error-Correction Overhead* (v1.0). Zenodo. https://doi.org/10.5281/zenodo.22109034

Version v1.0 record: https://doi.org/10.5281/zenodo.22109035
...
- `artifacts/verification/` — computational verification (floor arithmetic + H2 Monte Carlo + rendering gate), all reproducible with Python 3 stdlib
