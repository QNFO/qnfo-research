...
- Every bib entry above is cited in the paper body (spencerbrown1969 §2.1; umporr014 §1/§2.2/§4;
  res027 §1/§3.2/§4; res028 §1/§4; res029 §1/§4/§6; res030 §1/§2.7/§3.2; res021 §4).
- The in-preparation consolidation record (QNFO.RES.031) is mentioned in prose without a
  bib entry, as it carries no DOI yet — deliberate, not an orphan.

## Rendering check

- The rendered bibliography (pandoc --citeproc) was diffed against the titles above;
  all six DOI-carrying titles match the bib strings verbatim.
