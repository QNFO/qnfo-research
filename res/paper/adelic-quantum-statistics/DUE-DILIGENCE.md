...
| operationalizing-generalized-symmetries | (title per record) | no Zenodo DOI (R2 key qnfo/releases/2026/01/Operationalizing Generalized Symmetries.md) | Anyon halos, non-invertible symmetry defects, FCI moiré — directly adjacent to the anyonic-intermediates open problem (red-team H2). [DOI corrected 2026-08-27: the round-1 reviewer's 10.5281/zenodo.18199396 does NOT resolve — resolve_paper_id returns doi:null] |
