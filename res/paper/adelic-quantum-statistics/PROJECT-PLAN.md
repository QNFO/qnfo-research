...
6. Registered P2 items: S9 (direct max-entropy variational check of the golden distributions) and S10 (executable F4 artifact — differential primon-gas audit deposited in artifacts/external-search/).
